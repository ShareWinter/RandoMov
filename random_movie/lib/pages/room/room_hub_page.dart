          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // Bottom spacing
                SizedBox(height: MediaQuery.of(context).padding.bottom + AppTheme.spacingXLarge),
              ],
            ),
          ),
        ),
          ...
          child: BackdropFilter(
            ...
            TextButton(
              onPressed: () async {
                ...
                final success = await roomProvider.joinRoom(code, user.id, user.name);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 48,
                    decoration: BoxDecoration(
                      color: widget.accentColor.withValues(alpha: isDark ? 0.2 : 0.12),
